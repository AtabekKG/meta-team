...
import Question_sign from '../../image/homequestion.png';
                ...
                <div className="container">
                    <div className="question">
                        <div className="question-group">
                            ...
                            <div>
                                <img src={Question_sign} alt=""/>
                            </div>
                        </div>
                        <div className="question-desc">
                            <div className="question-desc_accordion">
                                <input type="checkbox" id="accordion1"/>
                                <label htmlFor="accordion1" className="question-desc_accordion-label">
                                    <p>Что такое зарезервированные слова в программировании?</p>
                                    <BsChevronDown className="question-desc_accordion-label_icon"/>
                                </label>
                                <div className="question-desc_accordion-content">
                                    <div>
                                        <p>
                            ...
                            <div className="question-desc_accordion">
                                ...
                                <label htmlFor="accordion2" className="question-desc_accordion-label">
                            ...
                            <div className="question-desc_accordion">
                                ...
                                <label htmlFor="accordion3" className="question-desc_accordion-label">
                            ...
                            <div className="question-desc_accordion">
                                ...
                                <label htmlFor="accordion4" className="question-desc_accordion-label">
                            ...
                            <div className="question-desc_accordion">
                                ...
                                <label htmlFor="accordion5" className="question-desc_accordion-label">
                            ...
                            <div className="question-desc_accordion">
                                ...
                                <label htmlFor="accordion6" className="question-desc_accordion-label">
                            ...
                            <div className="question-desc_accordion">
                                ...
                                <label htmlFor="accordion7" className="question-desc_accordion-label">
